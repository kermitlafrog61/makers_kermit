...
# генераторы - специальные типы данных, которые единоразово создают значения 
# и исчезают из памяти, когда эти значения заканчиваются

# итераторы - те типы данных, по которым можно пройтись циклом и его элементы
#  не исчезают по окончанию цикла
